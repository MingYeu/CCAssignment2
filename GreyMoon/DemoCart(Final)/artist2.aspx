<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="artist2.aspx.cs" Inherits="DemoCart.artist2" %>
...
<body>
    <form id="form1" runat="server">
       ...
       <div>
           <br />
           <br />
           <asp:Image ID="Image1" runat="server" CssClass="auto-style5" Height="494px" ImageUrl="~/Artist2.png" Width="1524px" />
       </div>
         <div>
            <table>
            <tr>
             ...
             <asp:ImageButton ID="ImageButton5" runat="server" Height="55px" ImageUrl="~/fb-icon.png" PostBackUrl="https://www.facebook.com/media/set?vanity=187237172835558&set=a.188119716080637" />
             <asp:ImageButton ID="ImageButton6" runat="server" Height="55px" ImageUrl="~/insta icon.jpg" />
             <asp:ImageButton ID="ImageButton7" runat="server" Height="55px" ImageUrl="~/twitter icon.png" PostBackUrl="https://twitter.com/i/moments/1360183804447494144" />
             </td>
            <td>
                <asp:TextBox ID="TextBox1" runat="server" Height="274px" Width="724px" CssClass="auto-style6" OnTextChanged="TextBox1_TextChanged">                   Mangaka (漫画家) is the Japanese word for a manga artist. Outside Japan, 
                ...
                <td class="auto-style11">
                    <asp:Image ID="Image2" runat="server" Height="384px" ImageUrl="~/Artist2v2.PNG" Width="340px" CssClass="auto-style8" /></td>
        ...
        <div>
                <table>
                    <tr><td></td><td>
                        <asp:ImageButton ID="ImageButton2" runat="server" CssClass="auto-style13" Height="340px" ImageUrl="~/a2 g1.jpg" Width="241px" />
                        <asp:ImageButton ID="ImageButton3" runat="server" CssClass="auto-style14" Height="340px" ImageUrl="~/a2 g2.jpg" Width="241px" />
                        <asp:ImageButton ID="ImageButton4" runat="server" CssClass="auto-style14" Height="340px" ImageUrl="~/a2 v2.png" Width="241px" />
                        <asp:ImageButton ID="ImageButton8" runat="server" CssClass="auto-style14" Height="340px" ImageUrl="~/a2 v1.jpg" Width="241px" />
                        <asp:ImageButton ID="ImageButton9" runat="server" CssClass="auto-style13" Height="340px" ImageUrl="~/a2 p1.jpg" Width="241px" />
                       </td></tr>
                </table>
            </div>
    </form>
