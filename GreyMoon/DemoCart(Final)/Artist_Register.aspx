<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Artist_Register.aspx.cs" Inherits="DemoCart.Register" %>
...
<body>
  ...
  <%-- Main Medium --%>               
            ...
            <br />
            <asp:Label ID="Label6" runat="server" Text="USERNAME" CssClass="lbluser" Width="170px"></asp:Label>
            ...
            <asp:Label ID="Label7" runat="server" Text="PASSWORD" CssClass="lblpass" Width="161px"></asp:Label>
    ...
    <%-- Password  --%>             
            ...
            <asp:Label ID="Label8" runat="server" Text="REPEAT PASSWORD" CssClass="lblrepeat" Width="90px"></asp:Label>
            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtpassword" ControlToValidate="TextBox5" ErrorMessage="Incorrect" ForeColor="Red"></asp:CompareValidator>
