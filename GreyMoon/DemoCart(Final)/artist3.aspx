<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="artist3.aspx.cs" Inherits="DemoCart.artist3" %>
...
<body>
    <form id="form1" runat="server">
       ...
       <div>
           <br />
           <br />
           <asp:Image ID="Image1" runat="server" CssClass="auto-style5" Height="494px" ImageUrl="~/Artist3.png" Width="1548px" />
       </div>
         <div>
           <table>
            <tr>
             ...
             <asp:ImageButton ID="ImageButton5" runat="server" Height="55px" ImageUrl="~/fb-icon.png" PostBackUrl="https://www.facebook.com/media/set?vanity=187237172835558&set=a.188119962747279" />
             <asp:ImageButton ID="ImageButton6" runat="server" Height="55px" ImageUrl="~/insta icon.jpg" />
             <asp:ImageButton ID="ImageButton7" runat="server" Height="55px" ImageUrl="~/twitter icon.png" PostBackUrl="https://twitter.com/i/moments/1360184642951811079" />
             </td>
            <td>
                <asp:TextBox ID="TextBox1" runat="server" Height="274px" Width="767px">                   Mangaka (漫画家) is the Japanese word for a manga artist. Outside Japan, 
                ...
                <td class="auto-style9">
                    <asp:Image ID="Image2" runat="server" Height="384px" ImageUrl="~/Artist3v2.PNG" Width="362px" CssClass="auto-style10" /></td>
         ...
         <div>
                <table>
                    <tr><td></td><td>
                        <asp:ImageButton ID="ImageButton2" runat="server" CssClass="auto-style13" Height="340px" ImageUrl="~/a3 g1.png" Width="241px" style="margin-left: 90px; margin-top: 90px" />
                        <asp:ImageButton ID="ImageButton3" runat="server" CssClass="auto-style11" Height="340px" ImageUrl="~/a3 g2.jpg" Width="241px" />
                        <asp:ImageButton ID="ImageButton4" runat="server" CssClass="auto-style11" Height="340px" ImageUrl="~/a3 v2.jpg" Width="241px" />
                        <asp:ImageButton ID="ImageButton8" runat="server" CssClass="auto-style11" Height="340px" ImageUrl="~/a3 v1.jpg" Width="241px" />
                        <asp:ImageButton ID="ImageButton9" runat="server" CssClass="auto-style13" Height="340px" ImageUrl="~/a3 p1.jpeg" Width="241px" style="margin-left: 90px; margin-top: 90px" />
                       </td></tr>
                </table>
            </div>
    </form>
